...
RcEcommAdapter rcEcommAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(type==2){
            ...
            rcFeedAdapter=new RcFeedAdapter(options,this,true);
            ...
            linearLayoutManager.setReverseLayout(true);
            linearLayoutManager.setStackFromEnd(true);
            rcVacancyAdapter=new RcVacancyAdapter(options,this,true);
            recyclerView.setLayoutManager(linearLayoutManager);
            ...
            FirebaseRecyclerOptions<clsLaborModel> options= new FirebaseRecyclerOptions.Builder<clsLaborModel>()
                    ...
                    .build();
            rcLabourAdapter=new RcLabourAdapter(options,this);
            LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getBaseContext());
            linearLayoutManager.setReverseLayout(true);
            linearLayoutManager.setStackFromEnd(true);
            recyclerView.setLayoutManager(linearLayoutManager);
            ...
            rcAnimalAdapter=new RcAnimalAdapter(optionanimal,this,true);
            rcCultivatonPrdtAdpter=new RcCultivatonPrdtAdpter(optionproduct,this,true);
            rcToolsAccesoriesAdapter=new RcToolsAccesoriesAdapter(optiontools,this,true);
